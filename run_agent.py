...
class AIAgent:
    ...
    def reset_session_state(
        ...
        # Failure counters are session-scoped and must not survive /new or /resume.
        from agent.runtime_circuit_breaker import SessionCircuitBreaker
        self._runtime_circuit_breaker = SessionCircuitBreaker()
